...
# 登录上雨课堂，然后按F12-->选Application-->找到雨课堂的cookies，寻找csrftoken和sessionid字段，并复制到下面两行即可  university_id : 2678
csrftoken = "TgTtX5EYociZGr3AmV6IMpkIufQBJ4OK" #需改成自己的
sessionid = "mr6a5u4dcrn1yroa8ui3sian7wlr2v8c" #需改成自己的
...
def one_video_watcher(video_id,video_name,cid,user_id,classroomid,skuid):
    ...
    url = "https://gracsu.yuketang.cn/"
    get_url = "https://gracsu.yuketang.cn/video-log/get_video_watch_progress/?cid="+str(cid)+"&user_id="+user_id+"&classroom_id="+classroomid+"&video_type=video&vtype=rate&video_id=" + str(video_id) + "&snapshot=1&term=latest&uv_id=2678"
...
def get_videos_ids(course_name,classroom_id,course_sign):
    get_homework_ids = "https://gracsu.yuketang.cn/mooc-api/v1/lms/learn/course/chapter?cid="+str(classroom_id)+"&term=latest&uv_id=2678&sign="+course_sign
...
if __name__ == "__main__":
    ...
    user_id_url = "https://gracsu.yuketang.cn/edu_admin/check_user_session/"
    ...
    # 然后要获取教室id
    get_classroom_id = "https://gracsu.yuketang.cn/mooc-api/v1/lms/user/user-courses/?status=1&page=1&no_page=1&term=latest&uv_id=2678"
    submit_url = "https://gracsu.yuketang.cn/mooc-api/v1/lms/exercise/problem_apply/?term=latest&uv_id=2678"
